...
- **Desconto Marginal Operado**: Central para entendimento da elasticidade do portfólio. A sua normalização revela o real poder de compra/precificação.
- **Ciclo Real de Vendas B2B**: Principal *proxy* para propensão à conversão e mapeamento de comportamento atípico do cliente final.
